...
class TemplateData 
{
    ...
    public static getTileMaxNutrient(val:number):number
    {
        var adb = [TILE_ADDIN_MONSTER_A, TILE_ADDIN_MONSTER_B, TILE_ADDIN_MONSTER_C, TILE_ADDIN_MONSTER_D ];
        return adb[val];
    }
    
    private static getMonsterData(tid:number):any
    {/*
        var adb = [ {sprID:10, heal:40,  heal_max:40,  heal_regen:0.1, dmg:2,  dmg_max:4,  atkSpeed:1000,  moveSpeed:1500},
                    {sprID:11, heal:120, heal_max:120, heal_regen:0.1, dmg:8,  dmg_max:14, atkSpeed:800,   moveSpeed:1000},
                    {sprID:12, heal:200, heal_max:200, heal_regen:0.1, dmg:14, dmg_max:22, atkSpeed:1200,  moveSpeed:2000},
                    {sprID:13, heal:400, heal_max:400, heal_regen:0.1, dmg:22, dmg_max:32, atkSpeed:1000,  moveSpeed:1500}
               ]; */  
        ...
        var adb = [ {sprID:10, heal:40,   heal_max:40,   heal_w: 36, heal_top: 6, armor:0.0, dmg:1,  dmg_max:3,  atkSpeed:1000,  moveSpeed:1500},
                    {sprID:11, heal:100,  heal_max:100,  heal_w: 36, heal_top: 0, armor:0.0, dmg:10, dmg_max:12, atkSpeed:600,   moveSpeed:1000},
                    {sprID:12, heal:200,  heal_max:200,  heal_w: 36, heal_top: 0, armor:0.3, dmg:12, dmg_max:16, atkSpeed:1000,  moveSpeed:2000},
                    {sprID:13, heal:600,  heal_max:600,  heal_w: 48, heal_top: 0, armor:0.1, dmg:30, dmg_max:40, atkSpeed:1400,  moveSpeed:1500}
                  ];
        
        return adb[tid-TILE_ADDIN_MONSTER_A];
    }
    
    private static getBraverData(tid:number):any
    {
        ...
        var adb = [ {sprID:1, heal:100, heal_max:100, heal_w: 48, heal_top: 0, armor:0.1, dmg:4,  dmg_max:8,  atkSpeed:1000, moveSpeed:2000},
                    ...
                    {sprID:3, heal:140, heal_max:140, heal_w: 48, heal_top: 0, armor:0.1, dmg:8,  dmg_max:12, atkSpeed:1000, moveSpeed:1500},
                    {sprID:4, heal:160, heal_max:160, heal_w: 48, heal_top: 0, armor:0.1, dmg:10, dmg_max:15, atkSpeed:1000, moveSpeed:2000},
                    {sprID:5, heal:180, heal_max:180, heal_w: 48, heal_top: 0, armor:0.1, dmg:13, dmg_max:18, atkSpeed:1000, moveSpeed:2000},
                    {sprID:6, heal:200, heal_max:200, heal_w: 48, heal_top: 0, armor:0.1, dmg:16, dmg_max:22, atkSpeed:1000, moveSpeed:1500},
                    {sprID:7, heal:260, heal_max:260, heal_w: 48, heal_top: 0, armor:0.1, dmg:20, dmg_max:26, atkSpeed:1000, moveSpeed:2000},
                    {sprID:8, heal:320, heal_max:320, heal_w: 48, heal_top: 0, armor:0.1, dmg:24, dmg_max:30, atkSpeed:1000, moveSpeed:2000},
                    {sprID:9, heal:420, heal_max:420, heal_w: 48, heal_top: 0, armor:0.1, dmg:30, dmg_max:36, atkSpeed:1000, moveSpeed:2000},
                  ];
                  
        return adb[tid-1];
    }
    
    public static getActorData(tid:number, isMonster:boolean):any
    {
        if (isMonster) {
    ...
    public static getSpawnWaveData(wave:number):any
    {
        var sb = 1;
        var se = 3;
